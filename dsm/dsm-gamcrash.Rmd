...
```{r plotsmooth, fig.cap="Plot of the smooth of Northing on the Guld of Mexico dolphins for a model with the default basis size (10, left) and a basis size of 20 (right).", fig.width=10, warning=FALSE}
