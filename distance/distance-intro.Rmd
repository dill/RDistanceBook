...
$$
where $x$ is the *perpendicular distance* from the line to the animal and $\sigma$ controls how likely we are to see an animal at a given distance. The larger the $\sigma$ the more likely we are to see animals at large distances. We'll look at this relationship in more detail in the next chapter.
...
[^presencecaveat]: Of course there are situations in which only presence/absence data is available or practical. We won't look at them here and instead concentrate on abundance.
