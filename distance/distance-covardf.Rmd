...
```
As Beaufort sea state is included as a factor covariate, which gives us a number of extra parameters in the model. We can see the affect of adding the covariate in a plot:
